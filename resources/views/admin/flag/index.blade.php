            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Flag Record</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="modal-content">
                <form action="" method="POST">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Delete Flag Record</h4>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(document).on('click', '.delete-record', function(e) {
                ...
                $('#deleteModal').modal('show').find('form').attr('action', '{{ url('admin/flag') }}/' + record)
            })
